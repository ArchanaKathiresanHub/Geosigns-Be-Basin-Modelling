...
namespace GeoPhysics
{
   namespace Brine
   {
      ...
      class Density: public Phases
      {
      public:
         /// Constructor
         Density( const double salinity );
         /// Virtual destructor
         virtual ~Density() {}
         ...
         double computeDerivativeP ( const double temperature, const double pressure ) const;
         ...
         /// \pre Input values should be within the defined ranges. In case they are not they will be internally adjusted to the relevant limits.
         /// \post The return of a double.
         double computeDerivativeT ( const double temperature, const double pressure ) const;
      ...
      protected:
         ...
         /// \post Guarantees the return of a non-negative value for the density.
         double vapourIdealGas ( const double temperature, const double pressure ) const;
         ...
         double derivativeTemperatureIdealGas( const double temperature, const double pressure ) const;

         /// Partial derivative of the density (using the Batzle-Wang equation) with respect to temperature.
         /// \pre Requires positive values for temperature, pressure, salinity.
         /// \post Guarantees the return of a negative number.
         double derivativeTemperatureBatzleWang( const double temperature, const double pressure ) const;
         ...
         double derivativePressureIdealGas( const double temperature, const double pressure ) const;

         /// Partial derivative of the density (using the Batzle-Wang equation) with respect to pressure.
         /// \pre Requires positive values for temperature, pressure, salinity.
         /// \post Guarantees the return of a positive number.
         double derivativePressureBatzleWang( const double temperature, const double pressure ) const;
