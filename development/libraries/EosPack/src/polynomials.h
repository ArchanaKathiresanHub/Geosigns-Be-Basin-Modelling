...
namespace polynomials
{
  ...
  namespace parse
	...
	public:
      ...
      Token GetNextToken(std::istream& istr);
  ...
  std::ostream& operator<<(std::ostream& os, const Term& range);
  std::ostream& operator<<(std::ostream& os, const Polynomial& poly);
  std::ostream& operator<<(std::ostream& os, const PiecewisePolynomial& piecewise);
