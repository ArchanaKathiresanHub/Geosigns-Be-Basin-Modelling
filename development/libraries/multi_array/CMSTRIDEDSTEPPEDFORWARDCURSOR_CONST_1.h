...
class CMSTRIDEDSTEPPEDFORWARDCURSOR<1,ENTRY>
{
public:
...
public:
  ...
  inline CMSTRIDEDSTEPPEDFORWARDCURSOR(const Tuple<1,int>& size, const Tuple<1,int>& steps, CONST ENTRY* data):
  ...
  inline CMSTRIDEDSTEPPEDFORWARDCURSOR(const Tuple<1,int>& size, const Tuple<1,int>& steps, 
    CONST ENTRY* data, const Tuple<1,int>& arrayPos):
    m_impl( size[0], steps[0], data, arrayPos[0] )
  {}
