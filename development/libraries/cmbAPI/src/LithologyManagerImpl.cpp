...
const char * LithologyManagerImpl::s_DensityFieldName = "Density";
const char * LithologyManagerImpl::s_HeatProductionFieldName = "HeatProd";
const char * LithologyManagerImpl::s_stpThermalCondAnisotrophyFieldName = "ThCondAnisotropy";
const char * LithologyManagerImpl::s_seisVeloExponentFieldName = "SeisVelocityExponent";
const char * LithologyManagerImpl::s_capEntryPresCoeff1FieldName = "CapC1";
const char * LithologyManagerImpl::s_capEntryPresCoeff2FieldName = "CapC2";
const char * LithologyManagerImpl::s_hrdrFracturingFieldName = "HydraulicFracturingPercent";
const char * LithologyManagerImpl::s_refSolidViscosityFieldName = "ReferenceSolidViscosity";
const char * LithologyManagerImpl::s_IgnIntruTemperatureFieldName = "IgneousIntrusionTemperature";
...
// Get Density
double LithologyManagerImpl::getLitPropDensity(LithologyID id)
{
   double val = Utilities::Numerical::IbsNoDataValue;
   ...
   try
   {
      ...
      val = rec->getValue<double>(s_DensityFieldName);
   }
   catch (const Exception & e)
   {
      reportError(e.errorCode(), e.what());
...
// Set Density
ErrorHandler::ReturnCode LithologyManagerImpl::setLitPropDensity(LithologyID id, double & val)
{
   ...
   try
   {
      ...
      database::Record * rec = m_lithIoTbl->getRecord(static_cast<int>(id));
      if (!rec) { throw Exception(NonexistingID) << "No lithology type with such ID: " << id; }
      rec->setValue(s_DensityFieldName, val);
   }
   catch (const Exception & e) { return reportError(e.errorCode(), e.what()); }
   return NoError;
}
...
// Get Heat Production
double LithologyManagerImpl::getLitPropHeatProduction(LithologyID id)
{
   double val = Utilities::Numerical::IbsNoDataValue;
   ...
   try
   {
      ...
      val = rec->getValue<double>(s_HeatProductionFieldName);
   }
   catch (const Exception & e)
   {
      reportError(e.errorCode(), e.what());
...
// Set Heat Production
ErrorHandler::ReturnCode LithologyManagerImpl::setLitPropHeatProduction(LithologyID id, double & val)
{
   ...
   try
   {
      ...
      database::Record * rec = m_lithIoTbl->getRecord(static_cast<int>(id));
      if (!rec) { throw Exception(NonexistingID) << "No lithology type with such ID: " << id; }
      rec->setValue(s_HeatProductionFieldName, val);
   }
   catch (const Exception & e) { return reportError(e.errorCode(), e.what()); }
   return NoError;
}
...
double LithologyManagerImpl::getLitPropThrConductivity(LithologyID id)
{
   double val = Utilities::Numerical::IbsNoDataValue;
...
ErrorHandler::ReturnCode LithologyManagerImpl::setLitPropThrConductivity(LithologyID id, double & val)
{
   ...
   try
   {
      ...
      database::Record * rec = m_lithIoTbl->getRecord(static_cast<int>(id));
      if (!rec) { throw Exception(NonexistingID) << "No lithology type with such ID: " << id; }
      rec->setValue(s_stpThermalCondFieldName, val);
   }
   catch (const Exception & e) { return reportError(e.errorCode(), e.what()); }
   return NoError;
}

// Get Thermal Conductivity Anistropy
double LithologyManagerImpl::getLitPropThrCondAnistropy(LithologyID id)
{
   double val = Utilities::Numerical::IbsNoDataValue;
   ...
   try
   {
      ...
      val = rec->getValue<double>(s_stpThermalCondAnisotrophyFieldName);
   }
   catch (const Exception & e)
   {
      reportError(e.errorCode(), e.what());
...
// Set Thermal Conductivity Anistropy
ErrorHandler::ReturnCode LithologyManagerImpl::setLitPropThrCondAnistropy(LithologyID id, double & val)
{
   ...
   try
   {
      ...
      database::Record * rec = m_lithIoTbl->getRecord(static_cast<int>(id));
      if (!rec) { throw Exception(NonexistingID) << "No lithology type with such ID: " << id; }
      rec->setValue(s_stpThermalCondAnisotrophyFieldName, val);
   }
   catch (const Exception & e) { return reportError(e.errorCode(), e.what()); }
   return NoError;
}

// Get Permeability Anistropy
double LithologyManagerImpl::getLitPropPermAnistropy(LithologyID id)
{
   double val = Utilities::Numerical::IbsNoDataValue;
   ...
   try
   {
      ...
      val = rec->getValue<double>(s_permeabilityAnisotropyFieldName);
   }
   catch (const Exception & e)
   {
      reportError(e.errorCode(), e.what());
...
// Set Permeability Anistropy
ErrorHandler::ReturnCode LithologyManagerImpl::setLitPropPermAnistropy(LithologyID id, double & val)
{
   ...
   try
   {
      ...
      database::Record * rec = m_lithIoTbl->getRecord(static_cast<int>(id));
      if (!rec) { throw Exception(NonexistingID) << "No lithology type with such ID: " << id; }
      rec->setValue(s_permeabilityAnisotropyFieldName, val);
   }
   catch (const Exception & e) { return reportError(e.errorCode(), e.what()); }
   return NoError;
}

// Get Seismic Velocity
double LithologyManagerImpl::getLitPropSeisVelocity(LithologyID id)
{
   double val = Utilities::Numerical::IbsNoDataValue;
...
// Set Seismic Velocity
ErrorHandler::ReturnCode LithologyManagerImpl::setLitPropSeisVelocity(LithologyID id, double & val)
{
   ...
   try
   {
      ...
      database::Record * rec = m_lithIoTbl->getRecord(static_cast<int>(id));
      if (!rec) { throw Exception(NonexistingID) << "No lithology type with such ID: " << id; }
      rec->setValue(s_seisVelocityFieldName, val);
   }
   catch (const Exception & e) { return reportError(e.errorCode(), e.what()); }
   return NoError;
}

// Get Seismic Velocity Exponent
double LithologyManagerImpl::getLitPropSeisVeloExponent(LithologyID id)
{
   double val = Utilities::Numerical::IbsNoDataValue;
   ...
   try
   {
      ...
      val = rec->getValue<double>(s_seisVeloExponentFieldName);
   }
   catch (const Exception & e)
   {
      reportError(e.errorCode(), e.what());
...
// Set Seismic Velocity Exponent
ErrorHandler::ReturnCode LithologyManagerImpl::setLitPropSeisVeloExponent(LithologyID id, double & val)
{
   ...
   try
   {
      ...
      database::Record * rec = m_lithIoTbl->getRecord(static_cast<int>(id));
      if (!rec) { throw Exception(NonexistingID) << "No lithology type with such ID: " << id; }
      rec->setValue(s_seisVeloExponentFieldName, val);
   }
   catch (const Exception & e) { return reportError(e.errorCode(), e.what()); }
   return NoError;
}

// Get Entry Pressure Coefficient 1
double LithologyManagerImpl::getLitPropEntryPresCoeff1(LithologyID id)
{
   double val = Utilities::Numerical::IbsNoDataValue;
   ...
   try
   {
      ...
      val = rec->getValue<double>(s_capEntryPresCoeff1FieldName);
   }
   catch (const Exception & e)
   {
      reportError(e.errorCode(), e.what());
...
// Set Entry Pressure Coefficient 1
ErrorHandler::ReturnCode LithologyManagerImpl::setLitPropEntryPresCoeff1(LithologyID id, double & val)
{
   ...
   try
   {
      ...
      database::Record * rec = m_lithIoTbl->getRecord(static_cast<int>(id));
      if (!rec) { throw Exception(NonexistingID) << "No lithology type with such ID: " << id; }
      rec->setValue(s_capEntryPresCoeff1FieldName, val);
   }
   catch (const Exception & e) { return reportError(e.errorCode(), e.what()); }
   return NoError;
}

// Get Entry Pressure Coefficient 2
double LithologyManagerImpl::getLitPropEntryPresCoeff2(LithologyID id)
{
   double val = Utilities::Numerical::IbsNoDataValue;
   ...
   try
   {
      ...
      val = rec->getValue<double>(s_capEntryPresCoeff2FieldName);
   }
   catch (const Exception & e)
   {
      reportError(e.errorCode(), e.what());
...
// Set Entry Pressure Coefficient 2
ErrorHandler::ReturnCode LithologyManagerImpl::setLitPropEntryPresCoeff2(LithologyID id, double & val)
{
   ...
   try
   {
      ...
      database::Record * rec = m_lithIoTbl->getRecord(static_cast<int>(id));
      if (!rec) { throw Exception(NonexistingID) << "No lithology type with such ID: " << id; }
      rec->setValue(s_capEntryPresCoeff2FieldName, val);
   }
   catch (const Exception & e) { return reportError(e.errorCode(), e.what()); }
   return NoError;
}

// Get Hydraulic Fracturing
double LithologyManagerImpl::getLitPropHydFracturing(LithologyID id)
{
   double val = Utilities::Numerical::IbsNoDataValue;
   ...
   try
   {
      ...
      val = rec->getValue<double>(s_hrdrFracturingFieldName);
   }
   catch (const Exception & e)
   {
      reportError(e.errorCode(), e.what());
...
// Set Hydraulic Fracturing
ErrorHandler::ReturnCode LithologyManagerImpl::setLitPropHydFracturing(LithologyID id, double & val)
{
   ...
   try
   {
      ...
      database::Record * rec = m_lithIoTbl->getRecord(static_cast<int>(id));
      if (!rec) { throw Exception(NonexistingID) << "No lithology type with such ID: " << id; }
      rec->setValue(s_hrdrFracturingFieldName, val);
   }
   catch (const Exception & e) { return reportError(e.errorCode(), e.what()); }
   return NoError;
}

// Get ReferenceSolidViscosity
double LithologyManagerImpl::getLitPropRefSoldViscosity(LithologyID id)
{
   double val = Utilities::Numerical::IbsNoDataValue;
   ...
   try
   {
      ...
      val = rec->getValue<double>(s_refSolidViscosityFieldName);
   }
   catch (const Exception & e)
   {
      reportError(e.errorCode(), e.what());
...
// Set ReferenceSolidViscosity
ErrorHandler::ReturnCode LithologyManagerImpl::setLitPropRefSoldViscosity(LithologyID id, double & val)
{
   ...
   try
   {
      ...
      database::Record * rec = m_lithIoTbl->getRecord(static_cast<int>(id));
      if (!rec) { throw Exception(NonexistingID) << "No lithology type with such ID: " << id; }
      rec->setValue(s_refSolidViscosityFieldName, val);
   }
   catch (const Exception & e) { return reportError(e.errorCode(), e.what()); }
   return NoError;
}

// Get Intrusion Temperaturey
double LithologyManagerImpl::getLitPropIntrTemperature(LithologyID id)
{
   double val = Utilities::Numerical::IbsNoDataValue;
   ...
   try
   {
      ...
      val = rec->getValue<double>(s_IgnIntruTemperatureFieldName);
   }
   catch (const Exception & e)
   {
      reportError(e.errorCode(), e.what());
...
ErrorHandler::ReturnCode LithologyManagerImpl::setLitPropIntrTemperature(LithologyID id, double & val)
{
   ...
   try
   {
      ...
      database::Record * rec = m_lithIoTbl->getRecord(static_cast<int>(id));
      if (!rec) { throw Exception(NonexistingID) << "No lithology type with such ID: " << id; }
      rec->setValue(s_IgnIntruTemperatureFieldName, val);
   }
   catch (const Exception & e) { return reportError(e.errorCode(), e.what()); }
   return NoError;
}
