                                              ...
                                              std::vector<DiffusionLeak::OverburdenProp>& diffusionOverburdenProps) const
   {
      ...
      while (f != formations.end ())
      {
         ...
         if ((*d).formation () == *f)
         {
            ...
            if (!(*d).base ().valid ())
            {
               cerr << "Basin_Warning: Trap.cpp:1369: Exiting as no valid depth property found for base of overburden formation: '" <<
            ...
            if (!(*t).valid ())
            {
               cerr << "Basin_Error: Trap.cpp:1404: Exiting as no valid temperature property found for base of overburden formation: '" <<
                  (*f)->getName () << "' at time: " << snapshot->getTime () << "." << endl;
               cerr.flush ();
            ...
            if (!(*p).top ().valid ())
            {
               cerr << "Basin_Error: Trap.cpp:1413: Exiting as no valid permeability property found for base of overburden formation: '" <<
                  (*f)->getName () << "' at time: " << snapshot->getTime () << "." << endl;
               cerr.flush ();
         ...
         if (!(*d).base ().valid ())
         {
            cerr << "Basin_Error: Trap.cpp:1429: Exiting as no valid depth property found for base of overburden formation: '" <<
               (*f)->getName () << "' at time: " << snapshot->getTime () << "." << endl;
            cerr.flush ();
         ...
         if (!(*p).top ().valid ())
         {
            cerr << "Basin_Error: Trap.cpp:1438: Exiting as no valid permeability property found for top of overburden formation: '" <<
               (*f)->getName () << "' at time: " << snapshot->getTime () << "." << endl;
            cerr.flush ();
         ...
         if (!(*t).valid ())
         {
            cerr << "Basin_Error: Trap.cpp:1448: Exiting as no valid temperature property found for top of overburden formation: '" <<
               (*f)->getName () << "' at time: " << snapshot->getTime () << "." << endl;
            cerr.flush ();
