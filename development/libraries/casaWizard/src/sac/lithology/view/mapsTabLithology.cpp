...
void MapsTabLithology::disableWellAtIndex(const int index)
{
...
QVBoxLayout* MapsTabLithology::setWellsAndOptionsLayout()
{
...
void MapsTabLithology::setSmoothingOptionsLayout()
{
...
void MapsTabLithology::setIdwOptionsLayout()
{
...
void MapsTabLithology::setDefaultGridGenerationOptions()
{
...
void MapsTabLithology::connectSignalsAndSlots() const
{
...
QPushButton* MapsTabLithology::buttonExportOptimized() const
{
  return buttonExportOptimized_;
}

QPushButton*MapsTabLithology::buttonExportOptimizedToZycor() const
{
  return buttonExportOptimizedToZycor_;
}

QPushButton* MapsTabLithology::buttonRunOptimized() const
{
  return buttonRunOptimized_;
}

ActiveWellsTable* MapsTabLithology::activeWellsTable() const
{
  return activeWellsTable_;
}

int MapsTabLithology::numberOfActiveWells() const
{
  return activeWellsTable_->rowCount();
}

void MapsTabLithology::highlightWell(const QString& wellName)
{
  int wellIndex = -1;
...
void MapsTabLithology::slotInterpolationTypeChange(int interpolationType)
{
  iwdOptions_->setVisible(interpolationType == 0);
}

void MapsTabLithology::slotSmoothingTypeChange(int smoothingType)
{
  smoothingOptions_->setVisible(smoothingType > 0);
}

LithofractionVisualisation* MapsTabLithology::lithofractionVisualisation() const
{
  return lithofractionVisualisation_;
}

QSpinBox* MapsTabLithology::smoothingRadius() const
{
  return smoothingRadius_;
}

QPushButton*MapsTabLithology::createGridsButton() const
{
  return createGridsButton_;
}

QSpinBox* MapsTabLithology::pValue() const
{
  return pValue_;
}

QComboBox* MapsTabLithology::smoothingType() const
{
...
QComboBox* MapsTabLithology::interpolationType() const
{
