...
public:
   ...
   // return array of casa::RunCase objects
   std::vector<RunCase*> & caseSet() { return m_caseSet; }
...
std::vector<RunCase*> & ScenarioAnalysis::caseSet() { return m_pimpl->caseSet(); }
