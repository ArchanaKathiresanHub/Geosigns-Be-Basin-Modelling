...
// first, some types:
  typedef int int4; // assumes integer is 4 words long
  typedef short int int2; // assumes short integer is 2 words long
  typedef char int1; // assumes char is 1 word long
