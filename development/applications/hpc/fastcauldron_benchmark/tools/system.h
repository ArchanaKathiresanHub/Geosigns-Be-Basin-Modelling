...
namespace hpc
{
   ...
   public:
      ...
      std::shared_ptr<Path> clone() const;
      ...
      virtual std::shared_ptr<Path> getParentDirectory() const;

      /// Return a child of the current directory
      virtual std::shared_ptr<Path> getDirectoryEntry( const std::string & file ) const;
      ...
      virtual std::shared_ptr<std::ostream> writeFile() const;

      /// Read a file
      virtual std::shared_ptr<std::istream> readFile() const;
