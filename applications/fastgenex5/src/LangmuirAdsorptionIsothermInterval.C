...
LangmuirAdsorptionIsothermInterval::LangmuirAdsorptionIsothermInterval ( const LangmuirAdsorptionIsothermSample* lowerBound,
...
bool LangmuirAdsorptionIsothermInterval::temperatureInRange ( const double temperature ) const {
   return m_temperatureLow <= temperature and temperature <= m_temperatureHigh;
}



double LangmuirAdsorptionIsothermInterval::compute ( const double temperature,
...
double LangmuirAdsorptionIsothermInterval::computeVL ( const double temperature ) const {
...
std::string LangmuirAdsorptionIsothermInterval::image () const {
