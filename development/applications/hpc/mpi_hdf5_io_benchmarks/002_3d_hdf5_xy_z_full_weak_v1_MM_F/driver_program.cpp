...
// Weak scaling                                           //
// WORKS ONLY FOR MPI PROCESSES : 16,25,36,49,64,...,n**2 //
// A more general domain decomposition+weak scaling       //
...
int main (int argc, char **argv)
{
     ...
     for (int iL = 0; iL != I_DO_MAX; iL++) {
          ...
          const int COEF_A = 10;
          const int NX = COEF_A * pSqRoot;
          const int NY = COEF_A * pSqRoot;
          const int NZ = 400;
          const int CH_NZ = NZ;
          const int RANK = 3;
