...
namespace casa
{
   ...
   public:
      ...
      /// @return new CasaDeserializer object. Caling function must delete this object after serialization
      static CasaDeserializer * createDeserializer( std::istream & fid, const std::string & fileFormat, unsigned int ver );
