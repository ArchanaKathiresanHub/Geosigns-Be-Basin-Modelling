...
AllochMod::GeoMorphAllochthonousLithologyDistribution::~GeoMorphAllochthonousLithologyDistribution () {
}

//------------------------------------------------------------//

void AllochMod::GeoMorphAllochthonousLithologyDistribution::pickOutAllBoundaryPoints ( PointArray& boundaryPoints ) const {
...
void AllochMod::GeoMorphAllochthonousLithologyDistribution::pickOutAllInteriorPoints ( PointArray& interiorPoints ) const {
...
void AllochMod::GeoMorphAllochthonousLithologyDistribution::pickOutAllExteriorPoints ( PointArray& exteriorPoints ) const {
...
void AllochMod::GeoMorphAllochthonousLithologyDistribution::pickOutBoundaryPoints ( PointArray& boundaryPoints ) const {
...
void AllochMod::GeoMorphAllochthonousLithologyDistribution::pickOutInteriorPoints ( PointArray& interiorPoints ) const {
...
void AllochMod::GeoMorphAllochthonousLithologyDistribution::pickOutExteriorPoints ( PointArray& exteriorPoints ) const {
...
void AllochMod::GeoMorphAllochthonousLithologyDistribution::inputMap ( const std::string&            fileName,
...
void AllochMod::GeoMorphAllochthonousLithologyDistribution::loadGridMap () {
...
void AllochMod::GeoMorphAllochthonousLithologyDistribution::initialise () {
...
void AllochMod::GeoMorphAllochthonousLithologyDistribution::setPrimalCoordinates ( const int                 number,
...
void AllochMod::GeoMorphAllochthonousLithologyDistribution::setDualCoordinates ( const FloatingPointArray& primalCoordinates,
...
const AllochMod::BinaryMap& AllochMod::GeoMorphAllochthonousLithologyDistribution::getDistributionMap () const {
  return distributionMap;
}

//------------------------------------------------------------//

const AllochMod::BinaryMap& AllochMod::GeoMorphAllochthonousLithologyDistribution::getErodedDistributionMap () const {
  return erodedDistributionMap;
}

//------------------------------------------------------------//

const AllochMod::BinaryMap& AllochMod::GeoMorphAllochthonousLithologyDistribution::getDilatedDistributionMap () const {
  return dilatedDistributionMap;
}

//------------------------------------------------------------//

const AllochMod::BinaryMap& AllochMod::GeoMorphAllochthonousLithologyDistribution::getBoundaryMap () const {
  return boundaryMap;
}

//------------------------------------------------------------//

const Numerics::FloatingPointArray& AllochMod::GeoMorphAllochthonousLithologyDistribution::getXCoordinates ( const MapType m ) const {
...
const Numerics::FloatingPointArray& AllochMod::GeoMorphAllochthonousLithologyDistribution::getYCoordinates ( const MapType m ) const {
...
Numerics::Point AllochMod::GeoMorphAllochthonousLithologyDistribution::getPoint ( const MapType m,
                                                                          const int     i,
                                                                          const int     j ) const {
...
bool AllochMod::GeoMorphAllochthonousLithologyDistribution::pointIsExterior ( const int i,
                                                                      const int j ) const {
...
bool AllochMod::GeoMorphAllochthonousLithologyDistribution::pointIsInterior ( const int i,
                                                                      const int j ) const {
...
bool AllochMod::GeoMorphAllochthonousLithologyDistribution::pointIsOnBoundary ( const int i,
                                                                        const int j ) const {
...
bool AllochMod::GeoMorphAllochthonousLithologyDistribution::pointHasBeenSelected ( const MapType m,
                                                                           const int     i,
                                                                           const int     j ) const {
...
int AllochMod::GeoMorphAllochthonousLithologyDistribution::getNumberOfPointsInsideDomain () const {
  return insideBodyCount;
}

//------------------------------------------------------------//

int AllochMod::GeoMorphAllochthonousLithologyDistribution::getNumberOfPointsOutsideDomain () const {
  return outsideBodyCount;
}

//------------------------------------------------------------//

int AllochMod::GeoMorphAllochthonousLithologyDistribution::mapXDimension () const {
  return distributionMap.length ( 1 ) - 2;
}

//------------------------------------------------------------//

int AllochMod::GeoMorphAllochthonousLithologyDistribution::mapYDimension () const {
  return distributionMap.length ( 2 ) - 2;
}

//------------------------------------------------------------//

void AllochMod::GeoMorphAllochthonousLithologyDistribution::printInteriorMap ( std::ostream& o ) const {
...
void AllochMod::GeoMorphAllochthonousLithologyDistribution::printExteriorMap ( std::ostream& o ) const {
...
void AllochMod::GeoMorphAllochthonousLithologyDistribution::printBoundaryMap ( std::ostream& o ) const {
