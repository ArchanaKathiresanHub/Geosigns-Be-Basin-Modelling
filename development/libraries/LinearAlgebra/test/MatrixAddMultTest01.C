...
TEST ( GAXPY, NoTransNoTrans ) {
   ...
   blasMatMult       ( Numerics::NO_TRANSPOSE, Numerics::NO_TRANSPOSE, 1.0, mat1, mat2, 1.0, res );
...
TEST ( GAXPY, NoTransTrans ) {
   ...
   blasMatMult       ( Numerics::NO_TRANSPOSE, Numerics::TRANSPOSE, 1.0, mat1, mat2, 1.0, res );
...
TEST ( GAXPY, TransNoTrans ) {
   ...
   blasMatMult       ( Numerics::TRANSPOSE, Numerics::NO_TRANSPOSE, 1.0, mat1, mat2, 1.0, res );
...
TEST ( GAXPY, TransTrans ) {
   ...
   blasMatMult       ( Numerics::TRANSPOSE, Numerics::TRANSPOSE, 1.0, mat1, mat2, 1.0, res );
