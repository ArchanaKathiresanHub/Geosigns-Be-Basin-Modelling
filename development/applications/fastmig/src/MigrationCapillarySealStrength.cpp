...
namespace migration {
   ...
   double MigrationCapillarySealStrength::criticalTemperature(const Composition& composition, const double gorm) const
   {
   ...
   double MigrationCapillarySealStrength::interfacialTension(const Composition& composition, const double gorm,
