...
DerivedProperties::PrimaryFormationSurfacePropertyCalculator::PrimaryFormationSurfacePropertyCalculator ( const DataAccess::Interface::ProjectHandle*   projectHandle,
