...
# parallel version
   add_external_project_to_repository(
         ...
         CONFIGURE_OPTIONS 
           ...
           SPEED    "Release"      "--enable-production" "CFLAGS=-O2" "CXXFLAGS=-O2"
           SPEED    "Debug"        "--enable-production" "CFLAGS=-O0" "CXXFLAGS=-O0"
           SPEED    "DebugAll"     "--enable-debug" "CFLAGS=-O0" "CXXFLAGS=-O0"
           SPEED    "MemCheck"     "--enable-debug" "--enable-using-memchecker" "CFLAGS=-O0" "CXXFLAGS=-O0"
           SPEED    "CodeCoverage" "--enable-production" "CFLAGS=-O2" "CXXFLAGS=-O2"
           OS       "{CurrentPlatform}"     
