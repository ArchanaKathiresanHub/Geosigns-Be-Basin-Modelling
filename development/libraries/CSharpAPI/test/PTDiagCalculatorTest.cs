...
namespace Shell.BasinModeling.Cauldron.Test
{
	...
	public class PTDiagCalculatorTest
	{
		...
		private static int[] m_IsolinesSizes = { 66, 55, 55, 53, 56, 59, 68, 76, 86, 92, 124 };
		private static double[] m_CritPoint = { 909.24357, 10955874.7425 };
		...
		public void TestPTDiagramCalculator()
		{
			...
			bool ret = CauldronAPI.BuildPTDiagram(0, m_TrapCond[0], m_TrapCond[1], m_Composition, points, szIso, isolines);
			// check results
