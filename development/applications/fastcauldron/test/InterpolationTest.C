...
typedef VectorInterpolator<1> SimpleInterpolator;

void doTest ( const SimpleInterpolator::CoefficientArray xs,
              TestFunction func,
...
TEST( SimpleInterpolator, InterpolatorDegree )
{
   ...
   doTest ( xs, constantFunction, zeroFunction );
   doTest ( xs, linearFunction, zeroFunction );
   doTest ( xs, quadraticFunction, zeroFunction );
...
void doTest ( const SimpleInterpolator::CoefficientArray xs,
   ...
   SimpleInterpolator interp;
   SimpleInterpolator::CoefficientMatrix ys;
