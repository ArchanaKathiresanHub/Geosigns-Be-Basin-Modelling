...
public:
   ...
   //OTGC
   void SetAromaticity(const double &in_aromaticity);
   //OTGC
...
private:
   ...
   SpeciesProperties(const SpeciesProperties &);
   SpeciesProperties &operator=(const SpeciesProperties &);
};
...
//OTGC
inline void SpeciesProperties::SetAromaticity(const double &in_aromaticity)
{
