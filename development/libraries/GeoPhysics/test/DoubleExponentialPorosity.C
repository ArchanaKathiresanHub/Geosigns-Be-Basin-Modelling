...
TEST( DoubleExponentialPorosity, sub_arkose )
{
	...
	Porosity myPorosity( Porosity::create(DataAccess::Interface::DOUBLE_EXPONENTIAL_POROSITY, 0.41, 0.0, 0.0, 1.631e-8, 3.874e-8, 0.0, 0.1631e-8, 0.3874e-8, 0.0, false ));
   ...
   EXPECT_NEAR( 0.12095024636588726, myPorosity.calculate( 5.0e7, 5.0e7, true, 0.0 ), 1e-10 );
	...
	Porosity myPorosity2( Porosity::create(DataAccess::Interface::DOUBLE_EXPONENTIAL_POROSITY, 0.41, 0.05, 0.0, 1.631e-8, 3.874e-8, 0.0, 0.1631e-8, 0.3874e-8, 0.0 ,false));
...
TEST( DoubleExponentialPorosity, derivatives )
{
   ...
   {
      DoubleExponentialPorosity doubleExp(0.0, 0.0, 2.66E-07, 1.0E-07, 2.66E-08, 1.0E-08, false );
      EXPECT_NEAR( doubleExp.calculateDerivative( 1.0E+04, 1.0E+04, false, 0.0 ), 0.0, 1e-18);
   }
   {
      DoubleExponentialPorosity doubleExp( 0.2, 0.0, 2.66E-07, 1.0E-07, 2.66E-08, 1.0E-08, false );
      EXPECT_NEAR( doubleExp.calculateDerivative( 1.0E+04, 1.0E+04, false, 0.0 ), -3.6336746305326871E-08, 1e-18 );
   }
   {
      DoubleExponentialPorosity doubleExp( 0.6, 0.0, 2.66E-07, 1.0E-07, 2.66E-08, 1.0E-08, false );
   ...
   {
      DoubleExponentialPorosity doubleExp( 0.4, 0.0, 2.66E-07, 1.0E-07, 2.66E-08, 1.0E-08, false );
      EXPECT_NEAR( doubleExp.calculateDerivative( 1.0E+04, 1.0E+04, false, 0.0 ), -7.2856089325755894E-08, 1e-18 );
   }
   {
      DoubleExponentialPorosity doubleExp( 0.4, 0.4, 2.66E-07, 1.0E-07, 2.66E-08, 1.0E-08, false );
      EXPECT_NEAR( doubleExp.calculateDerivative( 1.0E+04, 1.0E+04, false, 0.0 ), 0.0, 1e-18);
   }
   {
      DoubleExponentialPorosity doubleExp( 0.4, 0.6, 2.66E-07, 1.0E-07, 2.66E-08, 1.0E-08, false );
