...
ScrollZoomer::ScrollZoomer(QwtPlotCanvas *canvas, const char *name):
    QwtPlotZoomer(QwtPlot::xBottom, QwtPlot::yLeft,
        QwtPicker::DragSelection, QwtPicker::AlwaysOff, canvas, name),
    d_cornerWidget(NULL),
    d_hScrollData(NULL),
    d_vScrollData(NULL)
{
...
void ScrollZoomer::updateScrollBars()
{
    ...
    else
    {
	    ...
	    if (layout->canvasMargin (xScrollBarAxis) > horizontalScrollBar()->extent())
	       layout->setCanvasMargin(layout->canvasMargin(xScrollBarAxis) 
    ...
    else
    {
	    ...
	    if (layout->canvasMargin (yScrollBarAxis) > verticalScrollBar()->extent())
	       layout->setCanvasMargin(layout->canvasMargin(yScrollBarAxis) 
