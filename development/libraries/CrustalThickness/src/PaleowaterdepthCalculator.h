...
namespace CrustalThickness
{
   ...
   private:
      ...
      const AbstractDerivedProperties::SurfacePropertyPtr m_presentDayPressureMantle;   ///< The present day pressure of the top mantle                           [MPa]
      const AbstractDerivedProperties::SurfacePropertyPtr m_currentPressureMantle;      ///< The current snapshot pressure of the top mantle                      [MPa]
      const AbstractDerivedProperties::SurfacePropertyPtr m_presentDayPressureBasement; ///< The present day pressure at the present day basement depth           [MPa]
      const AbstractDerivedProperties::SurfacePropertyPtr m_currentPressureBasement;    ///< The current snapshot pressure at the current snapshot basement depth [MPa]
