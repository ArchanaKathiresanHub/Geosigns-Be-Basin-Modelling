...
TEST( CalibrationTargetCreatorTest, testCreateFromExcel )
{
  ...
  targetsExpected.append(casaWizard::CalibrationTarget("TwoWayTime(1234568.0,987654.1,100.0)",  "TwoWayTime", 100, 1000.3234, 0, 1.0));
  targetsExpected.append(casaWizard::CalibrationTarget("TwoWayTime(1234568.0,987654.1,200.0)",  "TwoWayTime", 200, 5000.652, 0, 1.0));
  targetsExpected.append(casaWizard::CalibrationTarget("BulkDensity(1234568.0,987654.1,123.0)", "BulkDensity", 123, 2200, 0, 1.0));
  targetsExpected.append(casaWizard::CalibrationTarget("BulkDensity(1234568.0,987654.1,456.0)", "BulkDensity", 456, 2553.1278, 0, 1.0));
