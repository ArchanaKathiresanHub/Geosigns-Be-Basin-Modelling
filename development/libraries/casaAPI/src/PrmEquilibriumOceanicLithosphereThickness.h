...
/// @page CASA_EquilibriumOceanicLithosphereThicknessPage Equilibrium oceanic lithosphere thickness parameter
///
/// This parameter defines the equilibrium oceanic lithosphere thickness
/// The value is defined in units: @f$ [m] @f$
/// It is continuous parameter and his range can be from 0 to any other positive value

namespace casa
{
   /// @brief Equilibrium oceanic lithosphere thickness parameter
   class PrmEquilibriumOceanicLithosphereThickness : public Parameter
   {
   public:
     PrmEquilibriumOceanicLithosphereThickness( mbapi::Model& mdl, const std::vector<std::string>& parameters = {});

     PrmEquilibriumOceanicLithosphereThickness( const VarParameter * parent, const PrmEquilibriumOceanicLithosphereThickness& param, const double val);

     virtual ~PrmEquilibriumOceanicLithosphereThickness() {}
     ...
     PrmEquilibriumOceanicLithosphereThickness( CasaDeserializer & dz, unsigned int objVer );

     /// @brief Get type name of the serialaizable object, used in deserialization to create object with correct type
     /// @return object class name
     virtual const char * typeName() const { return "PrmEquilibriumOceanicLithosphereThickness"; }
   ...
   private:
      double m_value;             ///< Equilibrium oceanic lithosphere thickness value
   };
}
