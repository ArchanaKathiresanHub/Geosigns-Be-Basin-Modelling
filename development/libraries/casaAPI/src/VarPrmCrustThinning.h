...
namespace casa
{
   ...
   public:
      ...
      /// This variable parameter allows to define a crust thickness function as set of crust thinning events.
      ...
      VarPrmCrustThinning( CasaDeserializer & dz, unsigned int objVer ) : VarPrmContinuous( dz, objVer ) { ; }
      /// @}
