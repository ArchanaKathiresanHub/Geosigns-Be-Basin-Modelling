#ifndef _MULTI_ARRAY_RMSTRIDEARRAYFORWARDPOSCURSOR_H_
#define _MULTI_ARRAY_RMSTRIDEARRAYFORWARDPOSCURSOR_H_

#include "multi_array/RMStridedSteppedForwardCursor.h"

#define RMFORWARDPOSCURSOR RMStrideArrayForwardPosCursorBase
#define CURSOR RMStridedSteppedForwardCursor<DIM,ENTRY>
#define CONST
...
class RMStrideArrayForwardPosCursor: 
  public RMStrideArrayForwardPosCursorBase<DIM,ENTRY>
{
public:
  ...
  inline RMStrideArrayForwardPosCursor(ENTRY* data, const Tuple<DIM,int>& arraySteps, 
    const CloseOpenInterval<DIM,int>& domain ):
    RMStrideArrayForwardPosCursorBase<DIM,ENTRY>( RMStrideArrayForwardPosCursor( arraySteps, 
