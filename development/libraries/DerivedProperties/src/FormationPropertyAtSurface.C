...
bool DerivedProperties::FormationPropertyAtSurface::isPrimary () const {

   return m_formationProperty->isPrimary();
}

const DataAccess::Interface::GridMap* DerivedProperties::FormationPropertyAtSurface::getGridMap() const {
