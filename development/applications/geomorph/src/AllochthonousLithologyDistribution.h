...
namespace AllochMod {
  ...
  class AllochthonousLithologyDistribution : public Interface::AllochthonousLithologyDistribution {
  ...
  public :
    ...
    ~AllochthonousLithologyDistribution ();
  ...
  typedef std::vector<AllochthonousLithologyDistribution*> AllochthonousLithologyDistributionSequence;
...
template <typename PointSelector>
void AllochMod::AllochthonousLithologyDistribution::pickOutBoundaryPoints ( PointSelector&        select,
									    Numerics::PointArray& boundaryPoints ) {
...
template <typename PointSelector>
void AllochMod::AllochthonousLithologyDistribution::pickOutInteriorPoints ( PointSelector&        select,
									    Numerics::PointArray& interiorPoints ) {
...
template <typename PointSelector>
void AllochMod::AllochthonousLithologyDistribution::pickOutExteriorPoints ( PointSelector&        select,
									    Numerics::PointArray& exteriorPoints ) {
...
inline bool AllochMod::AllochthonousLithologyDistributionGreaterThan::operator ()( const AllochthonousLithologyDistribution* m1,
										   const AllochthonousLithologyDistribution* m2 ) const {
