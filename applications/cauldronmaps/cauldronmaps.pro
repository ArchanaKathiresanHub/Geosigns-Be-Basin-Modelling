...
INCLUDEPATH += ../../libraries/SerialDataAccess/src/Interface
INCLUDEPATH += ../../libraries/DataAccess/src
INCLUDEPATH += ../../libraries/DataAccess/src/Interface
INCLUDEPATH += ../../applications/MakeLeads/src

## obsolete? CCLDIR points to the BPA CauldronClientLib directory
## CCLDIR = /glb/home/ksaho3/CauldronClientLib.3.4.0

LIBS += ${BPA_HOME}/lib/libCauldronClientLib.a

LIBS += ../../libraries/lib/$(machine)/libSerialDataAccess.a
LIBS += ../../libraries/lib/$(machine)/libserialhdf5.a
LIBS += ../../libraries/lib/$(machine)/libCBMGenerics.a
LIBS += ../../libraries/lib/$(machine)/libutilities.a
LIBS += ../../libraries/lib/$(machine)/libdatabase.a
