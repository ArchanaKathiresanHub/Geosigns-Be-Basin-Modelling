...
struct WellData
{
  ...
  QVector<QString> calibrationTargetVars_;
  ...
  WellData(const double& xCoord = 0.0, const double& yCoord = 0.0, const QVector<double>& depth = {}, const std::size_t nCalibrationTargetVars = 0, const QVector<QString>& calibrationTargetVars = {}, const QVector<std::size_t>& nDataPerTargetVar = {}, const QVector<double>& calibrationTargetValues = {}, const QVector<double> calibrationTargetStdDeviation = {}) :
    xCoord_{xCoord},
    yCoord_{yCoord},
    depth_{depth},
    nCalibrationTargetVars_{nCalibrationTargetVars},
    calibrationTargetVars_{calibrationTargetVars},
