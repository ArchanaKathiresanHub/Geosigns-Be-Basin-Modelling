...
TEST( ConfigFileCtc, parameters ){
   ...
   EXPECT_EQ( 3330,    parameters.getBackstrippingMantleDensity()  );
   ...
   EXPECT_EQ( 1030,    parameters.getWaterDensity()                );
   ...
   EXPECT_EQ( 3330,    parametersCopy.getBackstrippingMantleDensity()  );
   ...
   EXPECT_EQ( 1030,    parametersCopy.getWaterDensity()                );
