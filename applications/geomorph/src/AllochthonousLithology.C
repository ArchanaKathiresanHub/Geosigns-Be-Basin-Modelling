...
AllochMod::AllochthonousLithology::AllochthonousLithology (Interface::ProjectHandle * projectHandle, database::Record * record) : 
...
AllochMod::AllochthonousLithology::~AllochthonousLithology () {
...
void AllochMod::AllochthonousLithology::computeInterpolant ( AllochthonousLithologyDistributionSequence& inputMaps,
...
void AllochMod::AllochthonousLithology::printDistributionMaps ( AllochthonousLithologyDistributionSequence& inputMaps,
                                                                std::ostream&                               output ) {
...
void AllochMod::AllochthonousLithology::computeTransformation ( const AllochthonousLithologyDistribution* lower, 
...
void AllochMod::AllochthonousLithology::saveInterpolant ( hid_t& fileId,
...
AllochMod::MapIntervalInterpolator* AllochMod::AllochthonousLithology::allocateIntervalInterpolator () const {
