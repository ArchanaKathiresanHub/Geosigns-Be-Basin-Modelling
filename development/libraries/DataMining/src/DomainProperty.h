...
namespace DataAccess {
   ...
   namespace Mining {
      ...
      public :
         ...
         const Interface::Property* getProperty () const;
         ...
         const DomainPropertyCollection* getPropertyCollection () const;
      ...
      private :
         ...
         /// The collection of all allocated properties.
         const DomainPropertyCollection*  m_collection;

         /// The snapshot to which the result apply.
         const Interface::Snapshot* m_snapshot;

         /// The property to which the results apply.
         const Interface::Property* m_property;
