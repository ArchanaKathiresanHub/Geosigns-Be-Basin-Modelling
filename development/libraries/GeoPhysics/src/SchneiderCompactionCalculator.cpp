/**
 * \file SchneiderCompactionCalculator.cpp
...
using Utilities::Physics::IdealGasConstant;
...
void SchneiderCompactionCalculator::computeOnTimeStep( Grid & grid )
{
   ...
   for ( int activeNodeIndex = 0; activeNodeIndex < numberOfActiveNodes; ++activeNodeIndex )
   {
      ...
      const double solidViscosity   = 1.0e9 * referenceSolidViscosity * exp( activationEnergy * temperatureTerm / IdealGasConstant );
