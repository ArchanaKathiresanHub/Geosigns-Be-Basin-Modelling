#ifndef _FASTCAULDRON_POROSITY_CALCULATOR_H_
#define _FASTCAULDRON_POROSITY_CALCULATOR_H_
...
public :
   ...
   PorosityCalculator ( LayerProps* formation, const Interface::Surface* surface, const Interface::Snapshot* snapshot );
...
class PorosityVolumeCalculator {

public :

   PorosityVolumeCalculator ( LayerProps* formation, const Interface::Snapshot* snapshot );
...
#endif // _FASTCAULDRON_POROSITY_CALCULATOR_H_
