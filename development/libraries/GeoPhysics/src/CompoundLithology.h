...
protected :
         ...
         double soilMechanicsPorosityFunction
         ( const double               ves,
               const double               maxVes,
               const bool                 loadingPhase,
               const bool                 includeChemicalCompaction ) const;

         double exponentialPorosityFunction
         ( const double               ves,
               const double               maxVes,
               const bool                 loadingPhase,
               const bool                 includeChemicalCompaction ) const;

         double exponentialDVoidRatioDP
         ( const double               ves,
               const double               maxVes,
               const bool                 loadingPhase,
               const bool                 includeChemicalCompaction,
         ...
         double soilMechanicsDVoidRatioDP
         ( const double               ves,
               const double               maxVes,
               const bool                 loadingPhase,
               const bool                 includeChemicalCompaction,
         ...
         double exponentialDVoidRatioDVes
         ( const double               voidRatio,
               const double               ves,
               const double               maxVes,
               const bool                 loadingPhase ) const;

         double soilMechanicsDVoidRatioDVes
         ( const double               Psi,
               const double               ves,
               const double               maxVes,
               const bool                 loadingPhase ) const;

         double exponentialPorosityDerivative
         ( const double               ves,
               const double               maxVes,
               const bool                 includeChemicalCompaction,
               const double               chemicalCompactionTerm ) const;
         ...
         void mixSurfacePorosity ();

         void mixPorosityModel();

         void mixCompactionCoefficients ();

         void setMinimumPorosity ();

         void setMinimumExponentialPorosity ();

         void setMinimumSoilMechanicsPorosity ();
         ...
         double           m_density;
         double           m_depositionalPorosity;
         double           m_depositionalVoidRatio;
         ...
         DataAccess::Interface::PorosityModel m_porosityModel;
...
inline double GeoPhysics::CompoundLithology::referenceVoidRatio () const {
   return m_depositionalVoidRatio;

#if 0
   return m_depositionalPorosity / ( 1.0 - m_depositionalPorosity );
#endif
