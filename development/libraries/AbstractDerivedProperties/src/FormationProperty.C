...
AbstractDerivedProperties::FormationProperty::FormationProperty ( const DataModel::AbstractProperty*  property,
...
double AbstractDerivedProperties::FormationProperty::interpolate ( unsigned int i,
                                                                   unsigned int j,
                                                                   double       k ) const {
...
double AbstractDerivedProperties::FormationProperty::interpolate ( double i,
                                                           double j,
                                                           double k ) const {
