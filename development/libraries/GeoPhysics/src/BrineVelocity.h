...
#ifndef _GEOPHYSICS_BRINE_VELOCITY_H_
#define _GEOPHYSICS_BRINE_VELOCITY_H_

#include "BrinePhases.h"

namespace GeoPhysics
{
   /// \brief BrineVelocity is intended to handle the calculations of seismic velocity for brines whose physical parameters (T,P,S) are
   ...
   class BrineVelocity: public BrinePhases
   {
   public:
      /// Constructor.
      BrineVelocity() {}
      /// Virtual destructor
      virtual ~BrineVelocity() {}
   protected:
   ...
   private:
      /// To ensure that the Batzle-Wang equation always returns positive values, a special and more strict limit on the maximum value of the pressure is needed.
      static const double PressureMaxForVelocity;
