#ifndef _MULTI_ARRAY_CMSTRIDEARRAYCONSTFORWARDPOSCURSOR_H_
#define _MULTI_ARRAY_CMSTRIDEARRAYCONSTFORWARDPOSCURSOR_H_

#include "multi_array/CMStridedSteppedConstForwardCursor.h"

#define CMFORWARDPOSCURSOR CMStrideArrayConstForwardPosCursorBase
#define CURSOR CMStridedSteppedConstForwardCursor<DIM,ENTRY>
#define CONST const
...
class CMStrideArrayConstForwardPosCursor: 
  public CMStrideArrayConstForwardPosCursorBase<DIM,ENTRY>
{
public:
  ...
  inline CMStrideArrayConstForwardPosCursor(ENTRY* data, const Tuple<DIM,int>& arraySteps, 
    const CloseOpenInterval<DIM,int>& domain ):
    CMStrideArrayConstForwardPosCursorBase<DIM,ENTRY>( CMStridedSteppedConstForwardCursor<DIM,ENTRY>( 
