...
ControllerLithology::ControllerLithology() :
  SacController(),
  ui_{},
  ...
  inputController_{new InputControllerLithology{ui_.inputTab(), scenario_, scriptRunController(), this}},
...
MainWindow& ControllerLithology::mainWindow()
{
  return ui_;
}

SacScenario& ControllerLithology::scenario()
{
  return scenario_;
}
