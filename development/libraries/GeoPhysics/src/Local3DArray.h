...
template <typename T>
inline const T& GeoPhysics::Local3DArray<T>::operator ()( const unsigned int i,
                                                          const unsigned int j,
                                                          const unsigned int k ) const {
...
template <typename T>
inline T& GeoPhysics::Local3DArray<T>::operator ()( const unsigned int i,
                                                    const unsigned int j,
                                                    const unsigned int k ) {
...
template <typename T>
void GeoPhysics::Local3DArray<T>::fill ( const T& value ) {
...
template <typename T>
inline unsigned int GeoPhysics::Local3DArray<T>::first ( const unsigned int dim ) const {
...
template <typename T>
inline unsigned int GeoPhysics::Local3DArray<T>::last ( const unsigned int dim ) const {
   assert ( /* 0 <= dim and */ dim < 3 );
   return m_last [ dim ];
}
...
template <typename T>
inline unsigned int GeoPhysics::Local3DArray<T>::length ( const unsigned int dim ) const {
   assert ( /* 0 <= dim and */ dim < 3 );
   return m_size [ dim ];
}
