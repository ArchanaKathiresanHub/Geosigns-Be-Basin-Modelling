#ifndef _FASTCAULDRON_CAPILLARY_ENTRY_PRESSURE_CALCULATOR_H_
#define _FASTCAULDRON_CAPILLARY_ENTRY_PRESSURE_CALCULATOR_H_
...
class CapillaryEntryPressureVolumeCalculator {
public :

   CapillaryEntryPressureVolumeCalculator ( LayerProps* formation, const Interface::Snapshot* snapshot );
   virtual ~CapillaryEntryPressureVolumeCalculator();
...
#endif // _FASTCAULDRON_CAPILLARY_ENTRY_PRESSURE_CALCULATOR_H_
