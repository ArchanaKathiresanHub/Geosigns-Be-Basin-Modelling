...
TEST(SacLithologyScenarioTest, testWriteRead)
{
  casaWizard::sac::SacLithologyScenario writeScenario{new casaWizard::StubProjectReader()};
  ...
  casaWizard::sac::SacLithologyScenario readScenario{new casaWizard::StubProjectReader()};
...
TEST(SacLithologyScenarioTest, testWellPrepToSAC)
{
  // Given
...
void createScenarioWithOptimizedLithofractions(casaWizard::sac::SacLithologyScenario& scenario)
{
...
TEST(SacLithologyScenarioTest, testGetLithopercentagesOfClosestWell)
{
  // Given
  casaWizard::sac::SacLithologyScenario scenario{new casaWizard::StubProjectReader()};
...
TEST(SacLithologyScenarioTest, testGetLithopercentagesOfClosestWellNoLithoFractionInLayer)
{
  // Given
  casaWizard::sac::SacLithologyScenario scenario{new casaWizard::StubProjectReader()};
  createScenarioWithOptimizedLithofractions(scenario);
