#ifndef FASTCAULDRON__FRACTURE_PRESSURE_MAP_CALCULATOR_H
#define FASTCAULDRON__FRACTURE_PRESSURE_MAP_CALCULATOR_H
...
class FracturePressureMapCalculator {

public :

   FracturePressureMapCalculator ( LayerProps* formation, const Interface::Surface* surface, const Interface::Snapshot* snapshot );
...
#endif // FASTCAULDRON__FRACTURE_PRESSURE_MAP_CALCULATOR_H
