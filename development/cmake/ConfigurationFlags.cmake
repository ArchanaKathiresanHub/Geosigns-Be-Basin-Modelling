...
if (UNIX)
   ...
   #Code Coverage
   set(CMAKE_C_FLAGS_CODECOVERAGE "-g -O2 ${FpModelCC} -prof_gen=srcpos -DNDEBUG" CACHE STRING "List of C compiler flags for a Intel Code Coverage build")
   set(CMAKE_CXX_FLAGS_CODECOVERAGE "-g -O2 ${FpModelCC} ${cxxVersion} -prof_dir=${CMAKE_BINARY_DIR} -prof_gen=srcpos -DNDEBUG" CACHE STRING "List of C++ compiler flags for a Intel Code Coverage build")
   if (CMAKE_BUILD_TYPE STREQUAL CodeCoverage)
    ...
    if (CMAKE_CXX_COMPILER_ID STREQUAL "MSVC") ## or "Intel" we will get there soon!
