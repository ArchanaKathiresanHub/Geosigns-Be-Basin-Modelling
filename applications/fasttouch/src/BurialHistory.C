...
tsLib_burHistTimestep* BurialHistory::returnAsArray (const int &i, const int &j, int &validTimesteps)
{
   Properties *p;
   validTimesteps = 0;
...
bool BurialHistory::loadPaleoData (void)
{
   ...
   m_burialHistoryTimestep = new tsLib_burHistTimestep [m_burialHistoryMap.size()];
