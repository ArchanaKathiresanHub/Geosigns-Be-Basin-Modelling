/* ================================================================== */
/* $Header: /nfs/rvl/users/ibs/RCS/EPT-HM/BB/genex4_util/src/ibsgetcnvrs.c,v 25.0 2005/07/05 08:03:56 ibs Stable $ */
/* ================================================================== */
/* 
 * $Log: ibsgetcnvrs.c,v $
 ...
 * RS6000 relkease
 *
 * Revision 21.1  2001/06/07 11:44:59  ibs
 ...
 *
 * Revision 19.0  2000/02/23 13:18:22  ibs
 ...
 *
 * Revision 15.0  1998/03/05 15:50:19  ibs
 * IBS+ 2.2 Release: 5 March 1998 Major: Multimig, 3D Uncertainty, 3D Viewer
 *
 * Revision 14.0  1997/09/16  18:11:30  ibs
 * IBS+ 2.1 Release: 16 Sept 1997 Major: Cauldron: unconf/uncert/plots
 *
 * Revision 13.0  1997/02/10  16:06:18  ibs
 * IBS+ 2.0 Release: 7 February 1997 Major: Cauldron 3D
 *
 * Revision 12.0  1996/07/15  14:57:18  ibs
 * IBS+ 1.1 Release: also ibs 1.6  release. 25-July-1996
 *
 * Revision 10.0  1996/03/11  12:42:53  ibs
 * IBS+ 1.0 Release: also ibs 1.5, sgt, reconmodel, stratagem release. 29-Feb-1996
 *
 * Revision 9.1  1995/11/20  13:08:55  ibs
...
Description:	Get the conversion ratio's of kerogen and asphaltene as
		calculated by GENEX
...
/*
------------------------------------------------------------------------------
IbsGetCnvrs -	Get the conversion ratio's of kerogen and asphaltene as
    ...
    float *        OutputKerogenResults)
{
   ...
   /* retrieve conversion ratio's */
   rc = GxGetGeologicalConversions (IBS_GX_SUBAREA, 
                                   IBS_GX_SRHORIZON,
                                   IBS_GX_LITHOLOGY,
                                   StartTimeFullRange,
                                   EndTimeFullRange,
                                   FullRangeKerogenResults,
                                   FullRangeAsphalteneResults);

   /* Translate retrieved results to requested time intervals */
   if (rc == GXE_NOERROR)
   {
      OutputKerogenResults [0] = (float) 0.0;
      for (i = 1; i < NOutputTimeValues; i++)
      {
         ...
         if (rc == GXE_NOERROR)
         {
            OutputKerogenResults [i] = (float) result;
         }
      }
   }
