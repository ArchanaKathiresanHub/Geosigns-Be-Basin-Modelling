...
Grid * ObjectFactory::produceGrid (double minI, double minJ, double maxI, double maxJ, unsigned int numI, unsigned int numJ)
{
   return new DistributedGrid (minI, minJ, maxI, maxJ, numI, numJ);
}
