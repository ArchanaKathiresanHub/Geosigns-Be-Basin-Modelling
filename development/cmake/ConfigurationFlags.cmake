...
if (UNIX)
   ...
   set(CMAKE_C_FLAGS_DEBUG"-g ${preciseFpModel}" CACHE STRING "List of C compiler flags for a Debug build") 
   set(CMAKE_CXX_FLAGS_DEBUG "-g ${preciseFpModel}" CACHE STRING "List of C++ compiler flags for a Debug build") 

   set(CMAKE_C_FLAGS_DEBUGALL "-g -DGLIBCXX_DEBUG ${preciseFpModel}" CACHE STRING "List of C compiler flags for a DebugAll build") 
   set(CMAKE_CXX_FLAGS_DEBUGALL "-g -DGLIBCXX_DEBUG ${preciseFpModel}" CACHE STRING "List of C++ compiler flags for a DebugAll build") 
